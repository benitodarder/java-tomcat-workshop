package local.tin.tests.tomcat.crud.model.domain.messaging;
...
import local.tin.tests.tomcat.crud.model.domain.abstracts.AbstractDomain;
import local.tin.tests.tomcat.crud.model.domain.abstracts.AbstractIdentifiable;
import local.tin.tests.tomcat.crud.model.domain.errors.CommonError;
import local.tin.tests.tomcat.crud.model.domain.interfaces.IMessage;
