...
import local.tin.tests.tomcat.crud.dao.interfaces.IAbstractDAO;
 ...
 * @param <C1>
 */
public abstract class AbstractDAO<C0 extends local.tin.tests.tomcat.crud.model.domain.interfaces.IIdentifiable, C1 extends local.tin.tests.tomcat.crud.model.persistence.interfaces.IIdentifiable>  implements IAbstractDAO<C0> {
