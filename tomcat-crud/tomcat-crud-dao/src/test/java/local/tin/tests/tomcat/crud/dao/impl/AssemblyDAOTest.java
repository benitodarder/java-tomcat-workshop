...
import local.tin.tests.tomcat.crud.dao.impl.AssemblyDAO;
import local.tin.tests.tomcat.crud.dao.impl.ProductDAO;
...
public class AssemblyDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.tomcat.crud.model.domain.product.Assembly domainObject;
    private local.tin.tests.tomcat.crud.model.persistence.product.Assembly dataObject;
    private local.tin.tests.tomcat.crud.model.persistence.embeddables.AssemblyId dataObjectId;
    private local.tin.tests.tomcat.crud.model.domain.compositeIds.AssemblyId domainbjectId;
    private ProductDAO mockedProductDAO;
    private local.tin.tests.tomcat.crud.model.domain.product.Product mockedDomainProduct;
    private local.tin.tests.tomcat.crud.model.persistence.product.Product mockedDataProduct; 
    ...
    public void setUp() throws DAOException {
        ...
        domainObject = new local.tin.tests.tomcat.crud.model.domain.product.Assembly();
        dataObject = new local.tin.tests.tomcat.crud.model.persistence.product.Assembly();
        dataObjectId = new local.tin.tests.tomcat.crud.model.persistence.embeddables.AssemblyId();
        domainbjectId = new local.tin.tests.tomcat.crud.model.domain.compositeIds.AssemblyId();
        mockedProductDAO = mock(ProductDAO.class);
        when(mockedDAOFactory.getDAO(local.tin.tests.tomcat.crud.model.persistence.product.Product.class)).thenReturn(mockedProductDAO);
        mockedDomainProduct = mock(local.tin.tests.tomcat.crud.model.domain.product.Product.class);
        mockedDataProduct = mock(local.tin.tests.tomcat.crud.model.persistence.product.Product.class);
