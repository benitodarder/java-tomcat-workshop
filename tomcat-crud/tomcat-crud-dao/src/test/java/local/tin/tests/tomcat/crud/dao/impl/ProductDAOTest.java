...
public class ProductDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.tomcat.crud.model.domain.product.Product domainObject;
    private local.tin.tests.tomcat.crud.model.persistence.product.Product dataObject;
    ...
    public void setUp() throws DAOException {    
        ...
        domainObject = new local.tin.tests.tomcat.crud.model.domain.product.Product();
        dataObject = new local.tin.tests.tomcat.crud.model.persistence.product.Product();
    }
