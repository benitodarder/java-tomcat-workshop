...
public class UnitDAOTest extends BaseDAOTest {
    ...
    private UnitDAO dao;
    private local.tin.tests.tomcat.crud.model.domain.product.Unit domainObject;
    private local.tin.tests.tomcat.crud.model.persistence.product.Unit dataObject;
    ...
    public void setUp() throws DAOException {
        ...
        domainObject = new local.tin.tests.tomcat.crud.model.domain.product.Unit();
        dataObject = new local.tin.tests.tomcat.crud.model.persistence.product.Unit();
    }
