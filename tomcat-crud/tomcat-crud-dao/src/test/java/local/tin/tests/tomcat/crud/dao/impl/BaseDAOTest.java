...
import local.tin.tests.tomcat.crud.dao.impl.ProductDAOFactory;
import local.tin.tests.tomcat.crud.dao.impl.ComponentDAO;
...
public abstract class BaseDAOTest {
    ...
    protected local.tin.tests.tomcat.crud.model.domain.product.Assembly mockedDomainAssembly;
    protected local.tin.tests.tomcat.crud.model.persistence.product.Assembly mockedDataAssembly;
    protected ComponentDAO mockedComponentDAO;
    protected local.tin.tests.tomcat.crud.model.domain.product.Component mockedDomainComponent;
    protected local.tin.tests.tomcat.crud.model.persistence.product.Component mockedDataComponent;    
    ...
    protected void setAssemblyMocks() throws DAOException {
        ...
        when(mockedDAOFactory.getDAO(local.tin.tests.tomcat.crud.model.persistence.product.Assembly.class)).thenReturn(mockedAssemblyDAO);
        mockedDomainAssembly = mock(local.tin.tests.tomcat.crud.model.domain.product.Assembly.class);
        mockedDataAssembly = mock(local.tin.tests.tomcat.crud.model.persistence.product.Assembly.class);
    ...
    protected void setComponentMocks() throws DAOException {
        ...
        when(mockedDAOFactory.getDAO(local.tin.tests.tomcat.crud.model.persistence.product.Component.class)).thenReturn(mockedComponentDAO);
        mockedDomainComponent = mock(local.tin.tests.tomcat.crud.model.domain.product.Component.class);
        mockedDataComponent = mock(local.tin.tests.tomcat.crud.model.persistence.product.Component.class);
