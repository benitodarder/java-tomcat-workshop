...
import local.tin.tests.tomcat.crud.dao.impl.UnitDAO;
...
public class ComponentDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.tomcat.crud.model.domain.product.Component domainObject;
    private local.tin.tests.tomcat.crud.model.persistence.product.Component dataObject;
    private UnitDAO mockedUnitDAO;
    private local.tin.tests.tomcat.crud.model.domain.product.Unit mockedDomainUnit;
    private local.tin.tests.tomcat.crud.model.persistence.product.Unit mockedDataUnit;
    ...
    public void setUp() throws DAOException {   
        ...
        domainObject = new local.tin.tests.tomcat.crud.model.domain.product.Component();
        dataObject = new local.tin.tests.tomcat.crud.model.persistence.product.Component();
        mockedUnitDAO = mock(UnitDAO.class);
        when(mockedDAOFactory.getDAO(local.tin.tests.tomcat.crud.model.persistence.product.Unit.class)).thenReturn(mockedUnitDAO);
        mockedDomainUnit = mock(local.tin.tests.tomcat.crud.model.domain.product.Unit.class);
        mockedDataUnit = mock(local.tin.tests.tomcat.crud.model.persistence.product.Unit.class);        
